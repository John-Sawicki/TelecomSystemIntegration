...
public class VoltageDropActivity extends AppCompatActivity {
    ...
    EditText EditTemp, EditDistance, EditPower;
    Spinner SpinVoltage;
    CheckBox CheckJbx;
    String tempString, distanceString, powerString, voltageString;
    int voltagePosition= 0;
    double voltage = 120.0, result;
    int voltageArray[] = {12,24,24,120,208,230};
    double awgArea[] = {2.08,3.31,5.26};
    double metricArea[]= {1.5,2.5,4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckJbx = (CheckBox)findViewById(R.id.check1);
        ...
        calcButton.setOnClickListener(new View.OnClickListener() {
            ...
            metric = CheckJbx.isChecked();  //checked for metric units
            switch(voltagePosition){        //match the values on the Spinner with int voltage values
                ...
                result = voltageDrop(Double.parseDouble(distanceString),Double.parseDouble(tempString),Double.parseDouble(powerString),voltage,metric);
    ...
    public double voltageDrop(double l, double t, double w, double v, boolean m){
        double length = l; double tempVD = t; double watt = w; double voltage = v; boolean metricVD = m;
